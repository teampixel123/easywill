            ...
            <form id="loginform" method="post" class="form-horizontal" action="">
              ...
              <div class="form-group">
                <div class="row text-center">
                  <label class="col-md-3 text-right pt-1 pl-0 pr-1" for="exampleInputEmail1">Mobile No. / Email</label>
                  <div class="col-md-9">
                    <input type="text" name="mob_email" id="mob_email" class="required form-control" placeholder="Mobile Number or Email">
                  </div>
                </div>
              </div>
              <div class="form-group">
                <div class="row text-center">
                  ...
                  <div class="col-md-9">
                    <input type="password" name="user_password" id="user_password" class="required form-control" placeholder="Password">
